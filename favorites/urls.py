...
urlpatterns = [
    ...
    path("monument/delete/<int:id>/", views.FavoriteMonumentDeleteView.as_view(), name="monument-delete"),
    path("article/delete/<int:id>/", views.FavoriteArticleDeleteView.as_view(), name="article-delete"),
